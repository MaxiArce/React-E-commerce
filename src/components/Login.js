            ...
            <form className="mt-16 flex flex-col space-y-6">
                <div className="w-full mx-auto shadow-sm -space-y-px">
                    <div>
                        ...
                        <input type="email" autoComplete="email" onChange={(e) => ValidateEmail(e.target.value)} required className={`appearance-none rounded-t-lg relative block w-full px-3 py-2 border border-gray-300 
                ...
                <button onClick={AccountLogin} className="font-bold text-white w-16 mx-auto bg-black rounded p-2">Listo!</button>
            </form>
        </div>
    )
}
